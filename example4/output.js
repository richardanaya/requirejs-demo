...
define("lib/logger_web", function(){});

define('lib/shared',['lib/shared'], function (shared) {
    var count = 0;
...
define('lib/bar1',['lib/shared','logger'], function (shared, logger) {
...
define('lib/bar2',['lib/shared','logger'], function (shared, logger) {
    var doSomething = function () {
        logger.log(shared.increment());
    };
